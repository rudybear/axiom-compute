...
pub mod opt_log;
/// Per-invocation local array HIR types (M3.20 — private-memory sibling of `shared`).
pub mod local;
...
pub use local::{
    LocalArrayId, LocalArrayTy, LocalArrayDecl, MAX_LOCAL_ARRAY_ELEMS, MAX_LOCAL_ARRAY_BYTES,
    LOCAL_ARRAY_SPILL_ADVISORY_BYTES, is_allowed_local_element,
};
pub use opt_log::{
